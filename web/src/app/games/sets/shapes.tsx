...
export function CardTile({
  ...
  return (
    <span
      className={`inline-flex items-center justify-center rounded-lg border-2 bg-surface shadow-sm transition-colors duration-150 dark:shadow-none ${padding} ${
        selected
          ? "border-indigo-500 ring-2 ring-indigo-400"
          : "border-line dark:ring-1 dark:ring-white/10"
      }`}
    >
